      ...
      <main className="mx-auto max-w-4xl px-4 py-16 md:px-6 md:py-20">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-serif font-bold text-foreground">How We Use Your Information</h1>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold text-foreground">Sharing Your Data</h2>
            <p className="text-muted-foreground leading-relaxed">
