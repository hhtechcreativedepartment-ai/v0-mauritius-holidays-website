      ...
      <main className="mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-20">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl font-serif font-bold text-foreground">Financial Protection Information</h1>
          ...
          <section className="space-y-3">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground">What ATOL Means</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Before You Book</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground">More Information</h2>
            <p className="text-muted-foreground leading-relaxed">
